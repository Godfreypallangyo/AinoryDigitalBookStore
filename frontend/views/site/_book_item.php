  ...
  <div class="bg-white py-4 mb-4">
                        <div class="row mx-4 my-4 product-item-2 align-items-start">
                            ...
                            <div class="col-md-5 ml-auto product-title-wrap">
                                ...
                                <p>
                                <a href="<?= Url::to(['site/book-details', 'isbn' => $model->book_isbn]) ?>" class="btn btn-black btn-outline-black rounded-0 d-block mb-2 mb-lg-0 d-lg-inline-block">View Details</a>
